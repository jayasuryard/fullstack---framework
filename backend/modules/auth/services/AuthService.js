 ...
 *
 * Source: Product/backend/modules/auth/services/AuthService.js +
 *         Product/backend/modules/auth/services/ForgotPasswordService.js
 * Generalization: removed product-specific business logic (maintenance mode check,
 * school-level validation, parent-child link fetching, teacher-specific fields).
 * The structural pattern (refresh-token rotation, tokenVersion invalidation,
 * account lockout, hashed refresh token storage) is preserved intact.
 *
 * To add product-specific fields to the JWT or /me payload, extend
 * buildUserPayload() in your product — do not edit this file.
 */
